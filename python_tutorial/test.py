...
if __name__ == "__main__":
    ...
    # test 2
    rev_polish_notation = "TP(0.0) TP(1.0) - abs"
    r = construct_expr_tree(rev_polish_notation)
    # Display infix notation
    print("Infix expression is:")
    inorder(r)
    ...
    delta = 0.05
    l_t_test, u_t_test = eval_func_bound("TP(0.0)", Y, predicted_Y, T, delta,
                                         Inequality.T_TEST)
    l_hoeffding, u_hoeffding = eval_func_bound("TP(0.0)", Y, predicted_Y, T,
