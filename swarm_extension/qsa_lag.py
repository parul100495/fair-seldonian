...
def QSA_Opt(X, Y, T):
    ...
    print("Actual candidate sol upperbound: ", eval_ghat_opt(candidateSolution, candidateData_X, candidateData_Y, candidateData_T))
...
def safetyTest(candidateSolution, safetyData_X, safetyData_Y, safetyData_T):
    upperBound = eval_ghat_opt(candidateSolution, safetyData_X, safetyData_Y, safetyData_T)
...
def candidateObjective(thetaToEvaluate, candidateData_X, candidateData_Y, candidateData_T, safety_size):
    ...
    upperBound = ghat_opt(thetaToEvaluate, candidateData_X, candidateData_Y, candidateData_T, True, safety_size)
    if upperBound > 0.0:
...
def getCandidateSolution(candidateData_X, candidateData_Y, candidateData_T, safety_size):
    ...
    print("Initial LS upperbound: ", eval_ghat_opt(initialSolution, candidateData_X, candidateData_Y, candidateData_T))
