...
##########################
def eval_expr_tree_conf_interval(t_node, Y, predicted_Y, T, inequality, predict_bound, safety_size, modified_h):
    """
    ...
    """
    if t_node is not None:
        l_x, u_x = eval_expr_tree_conf_interval(t_node.left, Y, predicted_Y, T, inequality, predict_bound, safety_size, modified_h)
        l_y, u_y = eval_expr_tree_conf_interval(t_node.right, Y, predicted_Y, T, inequality, predict_bound, safety_size, modified_h)
